...
namespace CameraTest
{
    internal class CNNLayers
    {
        ...
        {
            int originalWidth = matrix.ColumnCount;
            int originalHeight = matrix.RowCount;
            ...
            double q12 = matrix[Math.Min(yCeiling, originalHeight - 1), xFloor];
            double q21 = matrix[yFloor, Math.Min(xCeiling, originalWidth - 1)];
            double q22 = matrix[Math.Min(yCeiling, originalHeight - 1), Math.Min(xCeiling, originalWidth - 1)];
